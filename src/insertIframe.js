{
  ...
  if(!isExtensionExist)
  {
      ...
      clear_extension_iframe.style = "width: 355px; border: 0px; z-index: 2147483647; position: fixed; top: 0px; left: auto; right: 0px; height: 100%; display: block; margin: auto; border: 1px solid rgb(220, 220, 220);transition: transform 0.2s; transform: translateX(350px);";
